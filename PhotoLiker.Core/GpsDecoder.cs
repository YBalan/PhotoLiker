namespace PhotoLiker.Core
{
    public static class GpsDecoder
    {
        ...
        private static MetadataEntry Decoded(string name, string value, string[]? extraAttributeTypes = null) =>
            new(0, name, value, ExtraAttributeTypes: extraAttributeTypes);
